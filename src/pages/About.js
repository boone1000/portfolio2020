...
function About(){
    return <div className="page">
        ...
        <div className='wrapperPics'>
            <img className='aboutImage' src={require('../images/Ashleypic.jpg')} alt='backpacking pic'></img>
            <img className='aboutImage' src={require('../images/Aboutwhiteboard.jpg')} alt='backpacking pic'></img>
            {/* <img className='aboutImage' src={require('../images/feet.jpg')} alt='backpacking pic'></img> */}
        </div>
        ...
        <div className="wrapperText">
            ...
            <p className='main'>Hello! I'm a UX Designer and Researcher studying Human Centered Design and Engineering at the University of Washington in Seattle. </p>
